        ...
        if message["role"] == "assistant":
            ...
            if apply_chat_template:
                ...
                assert next_states[:len(states)] == states, \
                    ("Your tokenizer should be increasing, i.e., adding a new message should not change the tokenization of previous messages."
                    " For example, if you use Qwen3 in multi-turn cases, previous thinking may be eliminated."
                    " In this case, you may set `tokenizer_name=Chenmien/Qwen3-Increasing-Tokenizer`.")
